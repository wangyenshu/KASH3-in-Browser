...
emulator.add_listener("serial0-output-byte", function(byte)
{
    ...
    if(!booted && serial_text.includes("kash%"))
    {
        ...
        emulator.serial0_send('Exec("dmesg -n 1; sync; echo 3 > /proc/sys/vm/drop_caches");\n');

    }

    if(booted && !saving && serial_text.includes("kash%"))
    {
        console.error("\n\nKASH3 Ready. Saving state...");
        saving = true;
